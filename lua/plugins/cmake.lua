vim.keymap.set({ "n", "v" }, "<F5>", [[<cmd>lua Launch()<CR>]], { silent = true })
return {
    {
        ...
        keys = {
            { "<F6>", mode = { "n", "v" }, [[<cmd>CMakeSelectBuildPreset<CR>]] },
            -- { "<C-F7>", mode = { "n", "v" }, [[<cmd>CMakeSelectCwd<CR>]], },
            { "<F7>",   mode = { "n", "v" }, [[<cmd>CMakeBuild<CR>]] },

            { "<F6>", mode = "i",         [[<Esc><cmd>CMakeSelectBuildPreset<CR>]] },
